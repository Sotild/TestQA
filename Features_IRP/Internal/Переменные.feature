...
Сценарий: глобальные переменные
	...
	И я сохраняю навигационную ссылку текущего окна в переменную "$$$$СсылкаТоварБезХарактеристикккк$$$$"
	И я удаляю переменную "$$СсылкаТоварБезХарактеристикккк$$"
	И Я открываю навигационную ссылку "$$СсылкаТоварБезХарактеристикккк$$"
