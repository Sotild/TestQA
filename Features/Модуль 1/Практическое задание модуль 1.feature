...
//Первое и второе задание в одном features файле под разными сценариями. Скриншоты allure отдельными файлами. Этот комментарий добавлен  в облако через git панель
